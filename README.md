...
`${GOPATH}/src/github.com/millenovecento/mqttbeat`
...
```
git remote set-url origin https://github.com/millenovecento/mqttbeat
...
To clean  Mqttbeat source code, run the following command:
...
```
mkdir -p ${GOPATH}/src/github.com/millenovecento/mqttbeat
git clone https://github.com/millenovecento/mqttbeat ${GOPATH}/src/github.com/millenovecento/mqttbeat
```
